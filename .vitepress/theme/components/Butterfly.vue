<template>
  ...
  >
    ...
    <defs>
      <!-- <pattern> 是 SVG 的一个图案填充标签，可以在 pattern 中定义好图案，然后通过 id 引用来对某个图形进行填充
                <pattern> 的 width / height 属性默认是根据所填充图形的百分比来确定的。 -->
      <pattern
        id="image"
        width="1"
        height="1"
  ...
  <section class="scene3d">
    ...
    <div
      v-for="butterfly in butterflyStyles"
      :key="butterfly"
      class="butterfly_container"
      :class="butterfly.bfClass"
      :style="butterfly.bfStyle"
    >
      <var class="rotate3d">
        <var class="scale">
...
const butterflyStyles: any = ref([]);

butterflyStyles.value = [
  {
    bfClass: "scale_three_quarter",
    bfStyle: [
      { marginTop: "-120px" },
      { marginLeft: "-120px" },
      { animationDuration: `20s` },
    ],
    bfsStyle: [{ animationDuration: `.95s` }],
  },
  {
    bfClass: "scale_half",
    bfStyle: [
    ...
    bfsStyle: [{ animationDuration: `.75s` }],
  },
  {
    bfClass: "scale_half",
    bfStyle: [
    ...
    bfsStyle: [{ animationDuration: `.85s` }],
  },
  {
    bfClass: "scale_half",
    bfStyle: [
  ...
  },
  {
    ...
    bfsStyle: [{ animationDuration: `1.1s` }],
  },
  {
    bfClass: "scale_third",
    bfStyle: [
  ...
  },
  {
    ...
    bfsStyle: [{ animationDuration: `0.65s` }],
  },
  {
    bfClass: "scale_quarter",
    bfStyle: [
      { marginTop: "-260px" },
      { marginLeft: "-200px" },
      { animationDuration: `15s` },
    ],
    bfsStyle: [{ animationDuration: `0.55s` }],
  },
  {
    bfClass: "scale_quarter",
    bfStyle: [
    ...
    bfsStyle: [{ animationDuration: `0.75s` }],
  },
];
</script>
<style scoped>
@import url("./../utils/butterfly.css");
</style>
